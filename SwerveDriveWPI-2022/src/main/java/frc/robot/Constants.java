...
public final class Constants {
  ...
  public static final class DriveConstants {
    ...
    public static final double ENCODER_CLICKS_PER_ROTATION = 0.0;
    public static final double ENCODER_CLICKS_PER_METER = 0.0;
    public static final double ENCODER_CLICKS_PER_RADIAN = 0;

    public static final double DRIVE_VELOCITY_FACTOR = 100.0;
  }
  ...
  public static final class ModuleConstants {
    ...
    public static double kIModuleDriveController;
    public static double kDModuleDriveController;
  }
