...
public class SubSystemFactory {
    ...
    public DrivetrainSubsystem CreateSwerveDriveSubsystem(){
    ...
    WPI_Pigeon2 pigeon2 = new WPI_Pigeon2(DRIVETRAIN_PIGEON_ID);
    return new DrivetrainSubsystem(m_frontRightModule, m_backRightModule, m_frontLeftModule, m_backLeftModule, pigeon2);
    }
}
